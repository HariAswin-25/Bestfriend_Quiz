...
try:
    ...
    from backend.schemas import RoomCreate, JoinRoomRequest, RoomResponse, ToggleReadyRequest
    from backend.services.room_service import create_challenge_room, join_challenge_room
except ModuleNotFoundError:
    from database import get_db
    from models import Room, User
    from schemas import RoomCreate, JoinRoomRequest, RoomResponse, ToggleReadyRequest
    from services.room_service import create_challenge_room, join_challenge_room
