...
try:
    ...
    from backend.models import Question, CustomQuestion, Room, Answer
    from backend.schemas import QuestionResponse, CustomQuestionCreate, AnswerSubmit, FinishQuizRequest
except ModuleNotFoundError:
    from database import get_db
    from models import Question, CustomQuestion, Room, Answer
    from schemas import QuestionResponse, CustomQuestionCreate, AnswerSubmit, FinishQuizRequest
