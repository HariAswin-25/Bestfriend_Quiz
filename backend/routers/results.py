...
try:
    ...
    from backend.models import Room, Result, Leaderboard, User
    from backend.schemas import ResultResponse, LeaderboardItem, AnswerComparisonItem
    from backend.services.result_service import evaluate_room_results
except ModuleNotFoundError:
    from database import get_db
    from models import Room, Result, Leaderboard, User
    from schemas import ResultResponse, LeaderboardItem, AnswerComparisonItem
    from services.result_service import evaluate_room_results
