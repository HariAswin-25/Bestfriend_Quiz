...
try:
    from backend.models import Room, User, Question, CustomQuestion
    from backend.utils import generate_room_code
    from backend.schemas import CustomQuestionCreate
except ModuleNotFoundError:
    from models import Room, User, Question, CustomQuestion
    from utils import generate_room_code
    from schemas import CustomQuestionCreate
