...
try:
    from backend.models import Room, Answer, Question, CustomQuestion, Result, Leaderboard, User
    from backend.utils import calculate_match_percentage, get_achievement
except ModuleNotFoundError:
    from models import Room, Answer, Question, CustomQuestion, Result, Leaderboard, User
    from utils import calculate_match_percentage, get_achievement
